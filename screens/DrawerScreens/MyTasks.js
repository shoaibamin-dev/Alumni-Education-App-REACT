      ...
      >
        <View style={styles.updateLayout}>
          ...
          <View style={{ marginTop: 15 }}>
            ...
            <TouchableOpacity onPress={editTaskToggle} style={styles.saveBtn}>
              <Text
                style={[
                  styles.text,
        ...
        <Modal animationType="slide" transparent={true} visible={editTaskModal}>
          <View
            style={{
              flex: 1,
              alignItems: "center",
